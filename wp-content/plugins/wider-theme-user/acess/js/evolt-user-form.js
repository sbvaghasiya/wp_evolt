jQuery(document).ready(function($) {
	...
	"use strict";
	/* enter key / input. */
    $(document).find('.evolt-user-form-login .login-group').on('keypress', 'input', function(e) {
	...
	/* login click. */
	$(document).find('.evolt-user-form').on('click', '.button-login', function( e ) {
		e.preventDefault();
		user_press_login($(this));
	});

	/* register login */
    $(document).find('.evolt-user-form-register').on('click', '.btn-up-register', function( e ) {
		e.preventDefault();
		user_press_register( $(this) );
	});
	/* event press key register login */
    $(document).find('.evolt-user-form-register').on('keypress', 'input', function( e ) {
		wl_alert( $(this), '', 'hide' );
	});
	/* enter for register */
    $(document).find('.evolt-user-form').on('keypress', 'input', function(e) {
		var keycode = (e.keyCode ? e.keyCode : e.which);
		if (keycode == '13') {
			user_press_register($(this));
		}
	...
	function user_press_register( e ) {
		...
		/* form element. */
		var _form = e.parents('.evolt-user-form-register');
	...
	function user_press_login(e) {
		...
		/* form element. */
		var _form = e.parents('.evolt-user-form');
