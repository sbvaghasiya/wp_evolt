jQuery(document).ready(function($) {
	...
	var user_press_media_frame = wp.media.frames.tgm_media_frame = wp.media({
		className : 'media-frame evolt-user-form-media-frame',
		frame : 'select',
		multiple : false,
	...
	$(document.body).on('click', '.evolt-user-form-option-media button', function(e) {
	...
	user_press_media_frame.on('select', function(){
      ...
      * @author WiderThemes Team
      */
      $('.evolt-user-form-option-layout').on('click', 'ul li', function () {
    	  "use strict";
    	  ...
    	  $(this).parents('.evolt-user-form-option-layout').find('input').val($(this).data('value'));
	  });
      ...
      * @author WiderThemes Team
      */
	  $(".evolt-user-form-option-switch").on('click', 'td div, td label', function() {
		  "use strict";
