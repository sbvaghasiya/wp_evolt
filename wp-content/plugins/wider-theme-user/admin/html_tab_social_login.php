            ...
            <td>
             ...
             <?php
                $this->option_text(array(
                    ...
                    'title'=> esc_html__('Facebook API ID', 'evolt-user-form'),
                    'default' => '',
                 ...
                 $this->option_switch(array(
                    ...
                    'title'=> esc_html__('Status login google ', 'evolt-user-form'),
                    'default' => '1'
                ));
                ?>
        </tr>
...
<table class="form-table google" >
   <tbody>
            ...
            <tr class="evolt-user-form-option-google">
                <td>
                    <h3>
                    ...
                    <a href="https://console.cloud.google.com">Where do I get this info?</a>
                     ...
                     <?php 
                        $this->option_text(array(
                            ...
                            'title'=> esc_html__('Google Client ID', 'evolt-user-form'),
                            'default' => '',
