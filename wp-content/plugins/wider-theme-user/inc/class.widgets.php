...
if (! class_exists ( 'Case_Theme_User_Widget' )) {
	class Case_Theme_User_Widget extends WP_Widget {
		function __construct() {
			parent::__construct ( 'userpress_widget', __ ( 'Wider Theme User', 'evolt-user-form' ), array (
					'description' => __ ( 'Multiple user press forms.', 'evolt-user-form' ) 
			) );
		}
		...
		public function widget($args, $instance) {
			...
			echo do_shortcode('[evolt-user-form-login login_options="Default"]');
