...
if (! class_exists('Case_Theme_User')) {
    ...
    final class Case_Theme_User
    {
        ...
        function add_scrips()
        {
            ...
            wp_register_script( 'evolt-user-form', userpress()->acess_url . 'js/evolt-user-form.js', array('jquery'), '1.0.0' , true);
            wp_localize_script( 'evolt-user-form', 'userpress', array( 'ajax' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce(Case_Theme_User::NONCE) ) );
            wp_enqueue_script( 'evolt-user-form');
        }
        ...
        function add_admin_script()
        {
            ...
            // if page not evolt-user-form_admin.
        ...
        function add_template_script(){
            ...
            if(!has_shortcode( $post->post_content, 'evolt-user-form'))
                return ;
            
            preg_match_all ("/\[evolt-user-form(.*)\]/U", $post->post_content, $matches);
