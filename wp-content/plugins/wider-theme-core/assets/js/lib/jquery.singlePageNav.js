    ...
    if (typeof(one_page_options) != "undefined") {
        ...
        $('.is-one-page').on('click', function (e) {
            ...
            if ($(_id_data).length === 1) {
                ...
                $('.evolt-onepage-active').removeClass('evolt-onepage-active');
                _this.addClass('evolt-onepage-active');
        ...
        $.each($('.is-one-page'), function (index, item) {
            ...
            var waypoint = new Waypoint({
                ...
                handler: function(direction) {
                    if(direction === 'down'){
                        $('.evolt-onepage-active').removeClass('evolt-onepage-active');
                        $(item).addClass('evolt-onepage-active');
                    }
                    else if(direction === 'up'){
                        var prev = $(item).parent().prev().find('.is-one-page');
                        $(item).removeClass('evolt-onepage-active');
                        if(prev.length > 0)
                            prev.addClass('evolt-onepage-active');
                    }
                    else{
