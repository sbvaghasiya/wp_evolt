( function( $ ) {
    ...
    var WidgetPostCarouselHandler = function( $scope, $ ) {
        ...
        owlCarousel.each(function() {
            ...
            _this.parent().find('.evolt-carousel-filter').on('click', '.evolt-filter-item', function(e) {
                var filter_data = $(this).attr('data-filter');
                if($(this).hasClass('evolt-filter-active')) return;
                $(this).addClass('evolt-filter-active').siblings().removeClass('evolt-filter-active');
                owl.owlFilter(filter_data, function(_owl) {
                    $(_owl).find('.evolt-item').each(owlAnimateFilter);
                });
            });
