 ...
 * @since 1.0.0
 */
class EVOLT_Element_Section extends Element_Section {
    ...
    public function __construct( array $data = [], array $args = null ) {
        ...
        $this->custom_params = apply_filters('evolt-custom-section/custom-params', []);
        $this->custom_presets = apply_filters('evolt-custom-section/custom-presets', []);
    }
    ...
    protected function content_template() {
        $beforeElementorRow = apply_filters('evolt-custom-section/before-elementor-row', '', []);
        ...
        let custom_classes = elementor.hooks.applyFilters('evolt-custom-section-classes', settings);
    ...
    public function before_render() {
        ...
        <<?php echo esc_html( $this->get_html_tag() ); ?> <?php $this->print_render_attribute_string( '_wrapper' ); ?>>
            ...
            $custom_classes = apply_filters('evolt-custom-section-classes', [], $settings);
            $custom_classes = is_array($custom_classes)?$custom_classes:[];

            $beforeElementorRow = apply_filters('evolt-custom-section/before-elementor-row', '', $settings);
            ?>
