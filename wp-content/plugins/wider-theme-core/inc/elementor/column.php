 ...
 * @since 1.0.0
 */
class EVOLT_Element_Column extends Element_Column {
    ...
    public function __construct( array $data = [], array $args = null ) {
        ...
        $this->custom_params = apply_filters('evolt-custom-column/custom-params', []);
    }
    ...
    protected function content_template() {
        ...
        ?>
        <#
        let custom_classes = elementor.hooks.applyFilters('evolt-custom-column-classes', settings);
    ...
    public function before_render() {
        ...
        $custom_classes = apply_filters('evolt-custom-column-classes', [], $settings);
