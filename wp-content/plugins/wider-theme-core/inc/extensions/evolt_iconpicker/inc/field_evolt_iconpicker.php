...
if (!class_exists('ReduxFramework_evolt_iconpicker')) {
    class ReduxFramework_evolt_iconpicker {
        function __construct($field = array(), $value = '', $parent) {
            $this->parent = $parent;
            $this->field = $field;
            $this->value = $value;

            $this->extension_url = evolt_redux_extensions()->extensions_url . 'evolt_iconpicker/';
        }
        ...
        function render() {
            ...
            ?>
                <select name="<?php echo $this->field['name'] . $this->field['name_suffix']; ?>" class="evolt-iconpicker">
                    <option value=""><?php esc_html_e('No Icons', EVOLT_TEXT_DOMAIN) ?></option>
                    <?php
        ...
        public function enqueue() {
            ...
            if (!wp_script_is('jquery.fonticonpicker.js')) {
                wp_enqueue_script('jquery.fonticonpicker.js', EVOLT_URL . 'assets/lib/iconpicker/jquery.fonticonpicker.js', array('jquery'), 'all', true);
            }
            if (!wp_script_is('evolt-iconpicker-js')) {
                wp_enqueue_script(
                    'evolt-iconpicker-js',
                    $this->extension_url . 'inc/field_evolt_iconpicker.js',
        ...
        public function get_icons(){
            ...
            $icons = apply_filters("redux_evolt_iconpicker_field/get_icons", $icons);
