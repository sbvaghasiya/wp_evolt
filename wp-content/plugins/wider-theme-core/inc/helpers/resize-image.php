...
function evolt_stringify_attributes( $attributes ) {
    $atts = array();
...
if ( ! function_exists( 'evolt_resize' ) ) {
    /**
     * @param int $attach_id
     ...
     * @since 4.2
     */
    function evolt_resize( $attach_id = null, $img_url = null, $width = '', $height = '', $crop = false ) {
...
if(!function_exists('evolt_get_image_by_size')){
    function evolt_get_image_by_size( $params = array() ) {
        ...
        if ( is_string( $thumb_size ) && ( ( ! empty( $_wp_additional_image_sizes[ $thumb_size ] ) && is_array( $_wp_additional_image_sizes[ $thumb_size ] ) ) || in_array( $thumb_size, $sizes, true ) ) ) {
            ...
            if ( is_array( $thumb_size ) ) {
                ...
                $p_img = evolt_resize( $attach_id, null, $thumb_size[0], $thumb_size[1], true );
                ...
                if ( ! empty( $attachment ) ) {
                    ...
                    if ( $p_img ) {
                        ...
                        $attributes = evolt_stringify_attributes( array(
                            'class' => $thumb_class,
                            'src' => $p_img['url'],
                            'width' => $p_img['width'],
                            'height' => $p_img['height'],
