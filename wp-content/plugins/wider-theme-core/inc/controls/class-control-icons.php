 ...
 * @since 1.0.0
 */
class Wider_Theme_Core_Icons_Control extends \Elementor\Base_Data_Control {

    /**
     * Get emoji one area control type.
     *
     * Retrieve the control type, in this case `evolt_icons`.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function enqueue() {
        wp_enqueue_style('jquery.fonticonpicker.min.css', EVOLT_URL . 'assets/lib/iconpicker/css/jquery.fonticonpicker.min.css', array(), 'all');
        wp_enqueue_style('jquery.fonticonpicker.grey.min.css', EVOLT_URL . 'assets/lib/iconpicker/themes/grey-theme/jquery.fonticonpicker.grey.min.css', array(), 'all');
        wp_enqueue_script('jquery.fonticonpicker.js', EVOLT_URL . 'assets/lib/iconpicker/jquery.fonticonpicker.js', array('jquery'));
        wp_register_script('evolt_icons-control', EVOLT_URL . 'assets/lib/iconpicker/evolt-iconpicker.js', array('jquery', 'jquery.fonticonpicker.js'), '1.0.0');
        wp_enqueue_script( 'evolt_icons-control' );
        ...
        <div class="elementor-control-field">
            ...
            <div class="elementor-control-input-wrapper">
                ...
                <div class="evolt-group">
                    <#
                        var template = '<div class="evolt-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative"><a class="evolt-group-delete" href="#" style="position: absolute; z-index: 9; right: 10px; top: 8px;">&times;</a><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Icon', EVOLT_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><select class="elementor-control-tag-area evolt-iconpicker">';
                        template += '<option value=""><?php esc_html_e('No Icons', EVOLT_TEXT_DOMAIN) ?></option>';
                        ...
                        template += '</select></div></div></div></div><div class="elementor-control elementor-label-block"><div class="elementor-control-content"><div class="elementor-control-field"><label class="elementor-control-title"><?php esc_html_e('Url', EVOLT_TEXT_DOMAIN)?></label><div class="elementor-control-input-wrapper"><input type="url" class="elementor-control-tag-area elementor-input evolt-url-input" /></div></div></div></div></div>';
                    #>
                            ...
                            <div class="evolt-group-item" style="border: 1px solid #ccc; padding: 10px; margin-bottom: 10px; position: relative;">
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Icon', EVOLT_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <select class="elementor-control-tag-area evolt-iconpicker">
                                                    <#
                                                    var selected = ( '' === icon_val ) ? 'selected' : '';
                                                    #>
                                                    <option value="" {{ selected }}><?php esc_html_e('No Icons', EVOLT_TEXT_DOMAIN) ?></option>
                                                    <#
                                                    _.each( data.options, function( icons, group ) {
                                                    #>
                                ...
                                <div class="elementor-control elementor-label-block">
                                    <div class="elementor-control-content">
                                        <div class="elementor-control-field">
                                            <label class="elementor-control-title"><?php esc_html_e('Url', EVOLT_TEXT_DOMAIN)?></label>
                                            <div class="elementor-control-input-wrapper">
                                                <input type="url" class="elementor-control-tag-area elementor-input evolt-url-input" value="{{ url_val }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="evolt-group-actions" style="text-align: center;">
                    <button class="elementor-button elementor-button-default evolt-group-add" type="button">
                        ...
                        <span><?php esc_html_e('Add Item', EVOLT_TEXT_DOMAIN)?></span>
                    </button>
                </div>
            </div>
        </div>
