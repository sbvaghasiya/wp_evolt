 ...
 * @param $file
 */
function evolt_ie_setting_export($file)
{
    global $wp_filesystem;

    $option_name = evolt_ie_setting_get_opt_name($file);
...
function evolt_ie_setting_import($folder)
{
    // File exists?
    ...
    if (file_exists($file)) {
        ...
        $data = evolt_ie_replace_theme_options($data);
...
function evolt_ie_setting_get_opt_name($file)
{
    ...
    $opt_name = apply_filters('evolt_ie_options_name', 'custom_theme_options');
...
function evolt_ie_replace_theme_options($options)
{

    $_replaces = apply_filters('evolt_ie_replace_theme_options', array());
