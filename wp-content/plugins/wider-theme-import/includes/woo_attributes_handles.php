...
if (!function_exists('evolt_woo_attributes_export')) {
    function evolt_woo_attributes_export($file)
    {
...
if (!function_exists('evolt_woo_attributes_import')) {
    function evolt_woo_attributes_import($file)
    {
        if (file_exists($file) && class_exists('WooCommerce')) {
            ...
            update_option("evolt_ie_term_imported","not_imported");
        }
    }
}

if(!function_exists("evolt_woo_attributes_term_import")){
    function evolt_woo_attributes_term_import($file){
        if (file_exists($file) && class_exists('WooCommerce')) {
            update_option("evolt_ie_term_imported","imported");
            $data = file_get_contents($file);
            $atts_data = json_decode($data, true);
            $attributes = wc_get_attribute_taxonomies();
            if(is_array($attributes))
