...
function evolt_ie_content_import($options)
{
    ...
    $attachment = empty($options['attachment']) ? evolt_ie_add_placeholder_image() : null;
...
function evolt_ie_add_placeholder_image(){
    ...
    $_default_image = apply_filters('theme_core_ie-placeholder-image', evolt_ie()->plugin_dir . 'assets/theme-core-ie.jpg');
 ...
 * @param $attachment
 */
function evolt_ie_replace_content($content, $attachment){

    $_replaces = apply_filters('evolt_ie_replace_content', array(), $attachment);
