...
if (!function_exists('evolt_term_meta_export')) {
    function evolt_term_meta_export($file)
    {
        global $wp_filesystem;
        $post_types = apply_filters('evolt_post_types', array());
...
if (!function_exists('evolt_term_meta_import')) {
    function evolt_term_meta_import($file)
    {
        // File exists?
        if (file_exists($file)) {
