...
function evolt_ie_revslider_import($folder)
{
...
function evolt_ie_revslider_export($folder){
    ...
    if(class_exists('RevSliderSlider')){
        ...
        if ( $arrSliders ) {
            foreach ( $arrSliders as $slider ) {
                evolt_ie_revslider_export_slider($slider, $folder);
            }
        }
    }
}
 ...
 */
function evolt_ie_revslider_export_slider($slider, $folder){
    $id = $slider->id;
...
function old_evolt_ie_revslider_export($folder){
    global $wp_filesystem;
    ...
    if(class_exists('RevSlider')){
        ...
        if ( $arrSliders ) {
            ...
            foreach ( $arrSliders as $slider ) {
                ...
                $rev_file = evolt_ie_revslider_export_slider($slider_class, $slider->getAlias(), $slider->getParams());
 ...
 * export slider from data, output a file for download
 */
function old_evolt_ie_revslider_export_slider($slider, $alias, $sliderParams, $useDummy = false){
