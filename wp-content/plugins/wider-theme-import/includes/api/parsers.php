 ...
 */
if (!class_exists("EVOLT_WXR_Parser")) {
    class EVOLT_WXR_Parser
    {
        function parse( $file ) {
            // Attempt to use proper XML parsers first
            if ( extension_loaded( 'simplexml' ) ) {
                $parser = new EVOLT_WXR_Parser_SimpleXML;
            ...
            $parser = new EVOLT_WXR_Parser_Regex;
 ...
 */
if (!class_exists("EVOLT_WXR_Parser_SimpleXML")) {
    class EVOLT_WXR_Parser_SimpleXML
    {
        function parse( $file ) {
 ...
 */
if (!class_exists("EVOLT_WXR_Parser_XML")) {
    class EVOLT_WXR_Parser_XML
    {
        var $wp_tags = array(
 ...
 */
if (!class_exists("EVOLT_WXR_Parser_Regex")) {
    class EVOLT_WXR_Parser_Regex
    {
        var $authors = array();
        var $posts = array();
