...
?>
<div class="evolt-fancy-box evolt-fancy-box-layout2 <?php echo esc_attr($settings['evolt_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['evolt_animate_delay']); ?>ms">
