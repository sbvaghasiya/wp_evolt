...
<div class="evolt-slick-filter-wrap evolt-slick-filter-layout6">
    ...
    <div id="<?php echo esc_attr($html_id) ?>" class="evolt-product-carousel9 evolt-dots-style5 evolt-slick-slider evolt-arrow-middle woocommerce">
