...
<div class="evolt-slick-filter-wrap evolt-slick-filter-layout7">
    ...
    <div id="<?php echo esc_attr($html_id) ?>" class="evolt-product-carousel-reset1 evolt-product-carousel7 <?php if($settings['style_l7'] == 'style1') { echo 'evolt-dots-style6'; } else { echo 'evolt-dots-style7'; } ?> evolt-slick-slider evolt-arrow-middle woocommerce <?php echo esc_attr($settings['style_l7']); ?>">
                                ...
                                <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): 
                                    ...
                                    <div class="woocommerce-product-header">
                                        ...
                                        if(!empty($sale_price)) {
                                            ...
                                            <span class="evolt-onsale"><?php echo esc_attr($product_sale); ?>%</span>
                                        <?php }
                                        ?>
