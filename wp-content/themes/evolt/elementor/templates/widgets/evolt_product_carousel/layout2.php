...
<div id="<?php echo esc_attr($html_id) ?>" class="evolt-product-carousel2 woocommerce-product-meta-grid evolt-slick-slider evolt-arrow-middle woocommerce <?php echo esc_attr($settings['style']); ?>">
                               ...
                               <h4 class="woocommerce-product--title">
                                ...
                                <?php if(!empty($product_date) && $settings['style'] == 'style3') : ?>
                                    <div class="woocommerce-product--countdown">
                                        <div class="evolt-countdown evolt-countdown-product1" 
                                            ...
                                            <div class="evolt-countdown-inner" data-count-down="<?php echo esc_attr($product_date);?>"></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
