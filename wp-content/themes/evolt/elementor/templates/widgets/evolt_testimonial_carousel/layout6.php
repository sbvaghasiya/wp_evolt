...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="evolt-testimonial evolt-testimonial-carousel6 evolt-slick-slider evolt-dots-<?php echo esc_attr($settings['dot_style']); ?>">
                        ...
                        <div class="slick-slide">
                            <div class="item--inner <?php echo esc_attr($settings['evolt_animate']); ?>">
                                ...
                                <div class="item--holder">
                                    ...
                                    <?php } ?>
                                    <div class="item--meta">
                                        <span class="item--title <?php echo esc_attr($settings['evolt_animate_t']); ?>" data-wow-delay="<?php echo esc_attr($settings['evolt_animate_delay_t']); ?>ms">    
                                            <?php echo esc_attr($title); ?>
                                        </span>
                                        <span class="item--position <?php echo esc_attr($settings['evolt_animate_p']); ?>" data-wow-delay="<?php echo esc_attr($settings['evolt_animate_delay_p']); ?>ms"><?php echo esc_attr($position); ?></span>
                                    </div>
                                </div>
                           </div>
                        </div>
