...
?>
<div class="evolt-shop-banner evolt-shop-banner2 bg-image <?php echo esc_attr($evolt_animate); ?>" data-wow-delay="<?php echo esc_attr($evolt_animate_delay); ?>ms" <?php if(!empty($box_bg_image['url'])) : ?>style="background-image: url(<?php echo esc_url($box_bg_image['url']); ?>);"<?php endif; ?>>
