...
<div id="<?php echo esc_attr($html_id) ?>" class="evolt-blog-carousel-layout5 evolt-slick-slider evolt-dots-style5">
            ...
            <div class="carousel-item slick-slide">
                <div class="grid-item-inner <?php echo esc_attr($settings['evolt_animate']); ?>">
                    ...
                    <?php if($show_button == 'true') : ?>
                        <a class="item--readmore" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><i class="evolt-icon-plus"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        <?php endforeach; ?>
