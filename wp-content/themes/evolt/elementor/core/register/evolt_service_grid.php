<?php
// Post term options
$post_term_options = evolt_get_grid_term_options('service');

// Register Post Grid Widget
evolt_add_custom_widget(
    array(
        'name' => 'evolt_service_grid',
        'title' => esc_html__('Wider Service Grid', 'evolt' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/evolt_service_grid/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .evolt-grid .item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-grid .item--title',
                        ),
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .evolt-grid .item--content' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-grid .item--content',
                        ),
                        array(
                            'name' => 'box_overlay_color',
                            'label' => esc_html__('Box Overlay Color', 'evolt' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .evolt-service-grid1 .item--holder-hover' => 'background-color: {{VALUE}};',
                            ],
                            'condition' => [
                                'layout' => '1',
                            ],
