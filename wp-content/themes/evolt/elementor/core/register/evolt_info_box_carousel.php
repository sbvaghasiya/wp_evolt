...
evolt_add_custom_widget(
    array(
        'name' => 'evolt_info_box_carousel',
        'title' => esc_html__('Wider Info Box Slider', 'evolt'),
        'icon' => 'eicon-info-box',
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'first_letter',
                                    'label' => esc_html__('First Letter', 'evolt'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'description',
                                ...
                                array(
                                    'name' => 'main_color',
                                    'label' => esc_html__('Main Color', 'evolt' ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .evolt-infobox .item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-infobox .item--title',
                        ),
                        array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .evolt-infobox .item--description' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-infobox .item--description',
                        ),
                        array(
