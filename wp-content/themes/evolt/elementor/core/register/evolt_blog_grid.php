...
evolt_add_custom_widget(
    array(
        'name' => 'evolt_blog_grid',
        'title' => esc_html__('Wider Blog Grid', 'evolt' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/evolt_blog_grid/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
