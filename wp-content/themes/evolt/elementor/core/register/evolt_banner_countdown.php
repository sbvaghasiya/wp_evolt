...
evolt_add_custom_widget(
    array(
        'name' => 'evolt_banner_countdown',
        'title' => esc_html__('Wider Banner Countdown', 'evolt'),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .evolt-bc-carousel1 .item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-bc-carousel1 .item--title',
                        ),
                        array(
                            'name' => 'subtitle_color',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .evolt-bc-carousel1 .item--subtitle' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .evolt-bc-carousel1 .item--subtitle',
                        ),
                    ),
                ),
                array(
