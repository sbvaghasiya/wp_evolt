...
evolt_add_custom_widget(
    array(
        'name' => 'evolt_portfolio_carousel',
        'title' => esc_html__('Wider Portfolio Carousel', 'evolt' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/evolt_portfolio_carousel/layout-image/layout1.jpg'
                                ],
                                '2' => [
                                    'label' => esc_html__('Layout 2', 'evolt' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/evolt_portfolio_carousel/layout-image/layout2.jpg'
                                ],
                            ],
                        ),
                    ),
